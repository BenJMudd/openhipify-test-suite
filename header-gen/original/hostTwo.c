...
int main(int argc, char *argv[]) {
  ...
  cl_kernel kernel = clCreateKernel(program, "vecSub", &ret);
  ...
  cl_kernel kernelSub = clCreateKernel(program, "pScan", &ret);
  ...
  clEnqueueWriteBuffer(command_queue, ma_one, CL_TRUE, 0, sizeof(a), a, 0, NULL,
                       NULL);
  clEnqueueWriteBuffer(command_queue, mr_one, CL_TRUE, 0, sizeof(r), r, 0, NULL,
                       NULL);

  clSetKernelArg(kernelSub, 0, sizeof(ma_one), (void *)&ma_one);
  clSetKernelArg(kernelSub, 1, sizeof(mr_one), (void *)&mr_one);
  ...
  // Read GPU result
  clEnqueueReadBuffer(command_queue, mr_one, CL_TRUE, 0, sizeof(r), r, 0, NULL,
                      NULL);
